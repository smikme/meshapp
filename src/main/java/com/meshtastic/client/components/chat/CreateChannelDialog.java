...
public final class CreateChannelDialog {
    ...
    public static void show(DeviceState state,
        ...
        if (availableSlot < 0) {
            Toast.show(Toast.Type.WARNING, I18n.t("chat.toast.allChannelSlotsUsed"));
            return;
        }
        ...
        Label title = new Label(I18n.t("chat.channel.create.title"));
        ...
        createBtn.setOnAction(e -> {
            ...
            if (channelName.isEmpty()) {
                statusLabel.setText(I18n.t("chat.channel.enterName"));
                return;
            }
            ...
            if (slot < 0) {
                statusLabel.setText(I18n.t("chat.channel.noFreeSlots"));
                return;
            }
            ...
            listenerHolder[0] = () -> Platform.runLater(() -> {
                ...
                Toast.show(Toast.Type.SUCCESS, I18n.t("chat.channel.created", channelName));
                modalPane.hide();
                onCreated.run();
            });
